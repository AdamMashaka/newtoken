...
export default function Authority() {
	...
	return (
		<div className="max-w-md w-full rounded-none md:rounded-2xl p-4 md:p-8 bg-white dark:bg-gray-950 mx-auto relative z-10 overflow-hidden border border-gray-800 shadow-xl">
