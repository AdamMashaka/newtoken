...
export default function Liquidity() {
	...
	return (
		<div className="max-w-lg w-full rounded-none md:rounded-2xl p-4 md:p-8 bg-white dark:bg-black mx-auto relative z-10 overflow-hidden border dark:border-white/[0.2] shadow-xl">
