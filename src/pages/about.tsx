	...
	return (
		<Layout>
			<div className="w-full max-w-[1000px] mx-auto relative z-10 p-10 bg-black border rounded-2xl dark:border-white/[0.2]">
				<h3 className="text-2xl font-bold">Solana SPL Token Creator</h3>
				<p className="text-neutral-800 dark:text-neutral-200 mt-5">
				...
				<h3 className="text-2xl font-bold mt-10">Why Create Solana Tokens using Orion</h3>
				<p className="text-neutral-800 dark:text-neutral-200 mt-5">
